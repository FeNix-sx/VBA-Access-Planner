...
Итог по чеклисту: этапы 1–2 и пункты MEDIUM по формам `frmDayEvents` / `frmSearch` закрыты; дальше — LOW, транзакции синхронизации, контракт ошибок, этап 3 (по приоритету).
